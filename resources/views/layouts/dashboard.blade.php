  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ route('home') }}">
        <div class="sidebar-brand-text mx-3">Belajar</div>
      </a>
      ...
      <li class="nav-item {{ (request()->is('master/*')) ? 'active' : '' }}">
        ...
        <div id="collapsePagesMaster" class="collapse nav-item {{ (request()->is('master/*')) ? 'show' : '' }}" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item {{ (request()->is('master/buku*')) ? 'active' : '' }}" href="{{ route('get.buku') }}">Buku</a>
            <a class="collapse-item {{ (request()->is('master/penerbit*')) ? 'active' : '' }}" href="{{ route('get.penerbit') }}">Penerbit</a>
          </div>
        </div>
      </li>
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Copyright &copy; Renaldi Y 2022</span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
